# Generated by Powerlevel10k configuration wizard on 2024-10-22 at 16:26 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    distrobox               # see prompt_distrobox
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  typeset -g POWERLEVEL9K_DIR_OTHER_VISUAL_IDENTIFIER_EXPANSION=''
  ...
  function prompt_distrobox() {
    ...
    p10k segment -f blue -i '' -t $CONTAINER_ID
  }  
