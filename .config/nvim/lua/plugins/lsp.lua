        ...
        config = function()
            ...
            vim.api.nvim_create_autocmd('LspAttach', {
                ...
                callback = function(event)
                    ...
                    remap('<leader>fS', require('telescope.builtin').lsp_document_symbols, '[F]ind Document [S]ymbols')
                    remap('<leader>fs', require('telescope.builtin').lsp_dynamic_workspace_symbols, '[F]ind Workspace [S]ymbols')

                    remap('<leader>rn', vim.lsp.buf.rename, '[R]e[n]ame')

                    remap('<leader>ca', vim.lsp.buf.code_action, '[C]ode [A]ction', { 'n', 'x' })
                    remap('<leader>cf', vim.lsp.buf.format, "[C]ode [F]ormat", { 'n', 'v' })  
